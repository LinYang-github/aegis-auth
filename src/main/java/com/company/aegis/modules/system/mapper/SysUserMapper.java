...
public interface SysUserMapper extends BaseMapper<SysUser> {
        ...
        @org.apache.ibatis.annotations.Select("SELECT role_id FROM sys_user_role WHERE user_id = #{userId}")
        java.util.List<Long> selectRoleIdsByUserId(@org.apache.ibatis.annotations.Param("userId") Long userId);
